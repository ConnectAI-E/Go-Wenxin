...
func request_WenxinworkshopService_Balance_0(ctx context.Context, marshaler runtime.Marshaler, client WenxinworkshopServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_WenxinworkshopService_Balance_0(ctx context.Context, marshaler runtime.Marshaler, server WenxinworkshopServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BalanceRequest
	var metadata runtime.ServerMetadata
...
func RegisterWenxinworkshopServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WenxinworkshopServiceServer) error {
	...
	mux.Handle("POST", pattern_WenxinworkshopService_Balance_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/baidubce.ai_custom.v1.WenxinworkshopService/Balance", runtime.WithHTTPPathPattern("/rpc/2.0/ai_custom/v1/wenxinworkshop/balance"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_WenxinworkshopService_Balance_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_WenxinworkshopService_Balance_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterWenxinworkshopServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WenxinworkshopServiceClient) error {
	...
	mux.Handle("POST", pattern_WenxinworkshopService_Balance_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/baidubce.ai_custom.v1.WenxinworkshopService/Balance", runtime.WithHTTPPathPattern("/rpc/2.0/ai_custom/v1/wenxinworkshop/balance"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_WenxinworkshopService_Balance_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_WenxinworkshopService_Balance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"rpc", "2.0", "ai_custom", "v1", "wenxinworkshop", "balance"}, ""))
)
...
var (
	...
	forward_WenxinworkshopService_Balance_0 = runtime.ForwardResponseMessage
)
